...
class DataIngestion:
    ...
    # This is the main point to change if you need to read data from cloud/googleDrive or any other storage
    def download_data(self)-> str:
        '''
        Fetch data from the GitHub url or from cloud or from google drive
        '''
